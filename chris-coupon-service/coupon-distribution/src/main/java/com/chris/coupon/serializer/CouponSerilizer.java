package com.chris.coupon.serializer;
...
public class CouponSerilizer extends JsonSerializer<Coupon> {
    ...
    public void serialize(Coupon coupon, JsonGenerator generator, SerializerProvider serializerProvider) throws IOException {
        ...
        generator.writeStringField("template_id", coupon.getTemplateId().toString());
